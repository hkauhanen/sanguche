...
g <- ggplot(klo, aes(x=l, y=value)) + geom_line() + facet_grid(variable~database, scales="free") + xlab("Nudge to neighbourhood size, ℓ") + ylab("")
...
g
ggsave(filename="../../results/plots/ksweep.png", plot=g, device="png", units="px", width=3000, height=2000, dpi=400)
```
