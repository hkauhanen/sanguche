...
kl1 <- kloop(data, "WALS", variable="Delta_under", indvariable="status", klim=2000)
kl1$predictor <- "categorical"

kl2 <- kloop(data, "WALS", variable="Delta_under", indvariable="abs_corrected_phi", klim=2000)
...
kl1 <- kloop(data, "WALS", variable="Delta_over", indvariable="status", klim=2000)
kl1$predictor <- "categorical"

kl2 <- kloop(data, "WALS", variable="Delta_over", indvariable="abs_corrected_phi", klim=2000)
kl2$predictor <- "continuous"
